...
/**
 * <p>
 * The contract between the clock provider and desk clock. Contains definitions
 * for the supported URIs and data columns.
 * </p>
 * <h3>Overview</h3>
 * <p>
 * ClockContract defines the data model of clock related information. This data
 * is stored in a number of tables:
 * </p>
 * <ul>
 * <li>The {@link AlarmsColumns} table holds the user created alarms</li>
 * <li>The {@link InstancesColumns} table holds the current state of each alarm
 * in the AlarmsColumn table.</li>
...
public final class AlarmContract {
	 ...
	 * provider.
	 */
	public static final String AUTHORITY = "saphion.batterycaster";
	...
	private interface AlarmSettingColumns extends BaseColumns {
		...
		/**
		 * Audio alert to play when alarm triggers. Null entry means use system
		 * default and entry that equal Uri.EMPTY.toString() means no ringtone.
		 * 
		 * <p>
		 * Type: STRING
		 * </p>
	...
	protected interface AlarmsColumns extends AlarmSettingColumns, BaseColumns {
		 ...
		 * </p>
		 */
		public static final String BATTERY = "bat_level";

		/**
		 * Charging or Discharging. 1. charging 2. discharging 3. always
		 * <p>
		 * Type: INTEGER
		 * </p>
		 */
		public static final String CHARGE = "charge_or_discharge";
	 ...
	 */
	protected interface InstancesColumns extends AlarmSettingColumns,
			BaseColumns {
		/**
		 * The content:// style URL for this table.
		 */
		 ...
		 * 
		 * Can transitions to: HIDE_NOTIFICATION_STATE HIGH_NOTIFICATION_STATE
		 * DISMISSED_STATE
		 */
		 ...
		 * 
		 * Can transitions to: HIGH_NOTIFICATION_STATE
		 */
		 ...
		 * 
		 * Can transitions to: DISMISSED_STATE
		 */
